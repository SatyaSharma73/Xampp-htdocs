...
<main class="form-signin">
  <form method="POST" enctype="multipart/form-data">
    <img src="user_image/<?php echo $fetch->p_image;?>" style="width:180px;height:200px;border-radius: 20%;">
    <h1 class="h3 mb-3 fw-normal">Update Data</h1>
    <table cellpadding="10px">
      <tr>
        <td>Name</td><td><input type="text" name="name" class="form-control" value="<?php echo $fetch->Name;?>" placeholder="Eg. Pizza" class="area"></td>
      </tr>

      <tr>
        <td>Category</td><td><select name="course" class="form-control" id="cars">
  ...
  <?php } ?>
      ...
      <tr>
        <td>Description</td><td><input type="text" name="address" class="form-control" value="<?php echo $fetch->Address;?>" placeholder="Eg. Chicken with Ham"></td>
      </tr>
      <tr>
        <td>Price</td><td><input type="text" name="email" class="form-control" value="<?php echo $fetch->Email;  ?>" placeholder="Eg. 100"></td>
      </tr>
      <tr>
        <td>Food Picture</td>
    ...
    <input type="submit" name="Update" value="Update" class="w-10 btn btn-lg btn-success"><input type="hidden" name="id" value="<?php echo $fetch->U_ID;?>">
    <a href="employee.php"><button type="button" name="button" class="w-10 btn btn-lg btn-warning">Food List</button></a>
