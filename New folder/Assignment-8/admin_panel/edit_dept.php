...
<main class="form-signin">
  <form method="POST">
    ...
    <table cellpadding="10px">
      <tr>
        <td>Department</td><td><input type="text" name="name" value="<?php echo $fetch->c_name;?>" placeholder="Eg. Snacks" class="area"></td>
      </tr>
    </table>
    ...
    <a href="dept.php"><button type="button" name="button" class="w-10 btn btn-lg btn-warning">Category List </button></a>
