...
if (isset($_POST['Submit'])) {
  ...
  $query="insert into pizza set Name='".$_POST['Name']."',Type='".$_POST['Type']."',Price='".$_POST['Price']."'";
        ...
        <li>
          ...
          <form method="POST" enctype="multipart/form-data" class="form">
            ...
            <div class="form-group">
              <label for="email">Pizza name:</label>
              <div class="relative">
            ...
            <div class="form-group">
              ...
              <div class="relative">
                <input type="text" id="name" name="Type"  class="form-control"    required="" autofocus="">
            ...
            <div class="form-group">
              ...
              <div class="relative">
                <input class="form-control" name="Price" type="text" maxlength="10" required >
