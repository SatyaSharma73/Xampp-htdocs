...
<body>
  ...
  <form action="./pay/payment.php" method="POST">
    <table>
      ...
      <input type="hidden" name="surl" value="http://localhost/paymentgatewaysystem/pay/success.php">
      <input type="hidden" name="furl" value="http://localhost/paymentgatewaysystem/pay/failure.php">
      <tr>
