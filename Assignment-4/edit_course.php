...
<main class="form-signin">
  <form method="POST">
    ...
    <table cellpadding="10px">
      <tr>
        <td>Course Name :</td><td><input type="text" name="name" value="<?php echo $fetch->c_name;?>" placeholder="Eg. John" class="area"></td>
      </tr>
    </table>
    ...
    <a href="course.php"><button type="button" name="button" class="w-10 btn btn-lg btn-success">List Course</button></a>
