...
<main class="form-signin">
  <form method="POST" action="" enctype="multipart/form-data">
    ...
    <table cellpadding="10px">
      <tr>
        <td>Name </td><td><input type="text" name="name" value="" placeholder="Eg. Chowmin" class="form-control"></td>
      </tr>
      <tr>
        <td>Description</td>
        <!-- <td><input type="text" name="address" value="" placeholder="Eg. Cal Tech"></td> -->
        <td><input type="text" id="text" name="address" value="" class="form-control" placeholder="Chicken sauce Chowmin" required></td>
      </tr>
      <tr>
        <td>Price</td>
        <td><input type="text" id="email" name="email" class="form-control" placeholder="100" required autofocus></td>
      </tr>
      <tr>
        <td>Category Id </td><td><select name="course" class="form-control" id="cars">
  ...
  <?php } ?>
    ...
    <input type="submit" name="insert" value="SUBMIT" class="w-10 btn btn-lg btn-primary">
     <a href="employee.php"><button type="button" name="button" class="w-10 btn btn-lg btn-warning">Back</button></a>
